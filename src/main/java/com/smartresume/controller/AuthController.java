...
public class AuthController {
    ...
    public ResponseEntity<?> signup(@RequestBody User user) {
        if (user == null) return ResponseEntity.badRequest().body(Map.of("error", "Request body required"));
        if (user.getEmail() == null || user.getEmail().isBlank()) return ResponseEntity.badRequest().body(Map.of("error", "Email is required"));
        if (user.getPassword() == null || user.getPassword().isBlank()) return ResponseEntity.badRequest().body(Map.of("error", "Password is required"));
